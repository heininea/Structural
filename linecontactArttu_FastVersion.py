...
def main():
    ...
    ax.set_xlabel('X (mm)')
    ax.set_ylabel('Z (mm)')
    ax.set_title('Simulation of stress component sigma_xx in Grinding (MPa)')
    ...
    ax.set_xlabel('X (mm)')
    ax.set_ylabel('Z (mm)')
    ax.set_title('Simulation of stress component sigma_yy in Grinding (MPa)')
    ...
    ax.set_xlabel('X (mm)')
    ax.set_ylabel('Z (mm)')
    ax.set_title('Simulation of stress component sigma_zz in Grinding (MPa)')
    ...
    ax.set_xlabel('X (mm)')
    ax.set_ylabel('Z (mm)')
    ax.set_title('Simulation of stress component sigma_xz in Grinding (MPa)')
